...
#
 ...
 # buildings are corrected in nudge, that goes for ZZZtstacks aswell if provinces are altered
 # if the ZZZe crashes on start up ask for help (its most likely air bases in wrong prov)
...
#
 ...
 # be more hesitant if your ZZZnges gives the country controlling the state more longterm advantages, as balance can be rubbed in favour to one country for ZZZZing like adding an extra naval factory.
#
